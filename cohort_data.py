...
def unique_houses(filename):
    ...
    houses = {line.split("|")[2] for line in cohort_data if line.split("|")[2] != ""}
...
def hogwarts_by_house(filename):
    ...
    for line in cohort_data:
        ...
        if line[2] == "" and line[-1] == "G":
            ghosts.append(name)
        elif line[2] == "" and line[-1] == "I":
...
def all_students_tuple_list(filename):
    ...
    for record in cohort_data:
        ...
        if record[2] != "":
            student_record = (record[0] + " " + record[1], record[2], record[3], record[4])
